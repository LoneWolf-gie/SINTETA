...
<body style="background-color: #e9ecef;">
  ...
  <div class="preheader"
    ...
    Sinteta Verification Code, we received request for reset password.
  </div>
  <!-- end preheader -->

  <!-- start body -->
  <table border="0" cellpadding="0" cellspacing="0" width="100%"
    style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); transition: 0.3s; border-radius: 5px;">
    ...
    <tr>
      <td align="center" bgcolor="#e9ecef">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff"
              ...
              <p style="margin: 0;">
                Dear ${name},
                <br><br>
                We received your request to reset your password for Sinteta. We understand how important it is to regain
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          <a href="#"
                            style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">${verificationCode}</a>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td align="left" bgcolor="#ffffff"
              style="padding: 30px 24px 10px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Once you receive the verification code, kindly enter it into the designated field on
          ...
          <tr>
            <td align="left" bgcolor="#ffffff"
              ...
              <p style="margin: 0;">Sincerely yours,<br> Bluelock</p>
            </td>
          </tr>
          <!-- end copy -->
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#e9ecef"
              ...
              <p style="margin: 0;">Note: This is a legal notice, which is why you are receiving it.</p>
            </td>
          </tr>
          <!-- end permission -->
